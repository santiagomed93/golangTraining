...
/*
Why is it important to have setters and getters? we can format the data as it comes in,
perform error checking or other logic before it's stored. This is far better than just modifying
the properties.
*/
